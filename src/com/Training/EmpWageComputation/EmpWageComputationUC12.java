...
public class EmpWageComputationUC12 {
	static final int isPT = 1;
	static final int isFT = 2;

	private ArrayList<companyEmpWage> companyEmpWageArrayList;
	
	public EmpWageComputationUC12(List<companyEmpWage> empWageArrayList) {
		super();
	...
	public static void main(String[] args) {
		...
		EmpWageComputationUC12 empWageBuilderObject = new EmpWageComputationUC12(empWageArrayList);
